...
# mirror image
image.export_image(brd, 'docs/api_brd_mirror.png', mirror=True)

# display only 2 layers
image.export_image(brd, 'docs/api_brd_layer.png', layers=['dimension', 'pads'])

# display layer using eagle command
image.export_image(brd, 'docs/api_brd_command.png', command='display none dimension')
